...
namespace BankLibrary
{
    public class PremiumOverdraftCheckingAccount : CheckingAccount
    {
        ...
        public PremiumOverdraftCheckingAccount(string accountNumber, string accountHolder, decimal initalBalance, decimal overdraftLimit, decimal cashbackRate) :
            base(accountNumber, accountHolder, initalBalance, overdraftLimit)
        {
